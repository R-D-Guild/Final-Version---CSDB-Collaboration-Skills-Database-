...
})({"5jWuu":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a4198db07b1ac3fe";
"use strict";
...
},{}],"6PCZc":[function(require,module,exports) {
var _supabaseClient = require("./supabaseClient"); // Import the Supabase client
// DOM elements
...
const checkEmailExists = async (email)=>{
    const { data, error } = await (0, _supabaseClient.supabase).from("auth.users") // Querying the internal auth.users table
...
forgotPassForm.addEventListener("submit", async (event)=>{
    ...
    try {
        ...
        const { error } = await (0, _supabaseClient.supabase).auth.resetPasswordForEmail(email, {
            captchaToken
        });
        if (error) {
...
},{"./supabaseClient":"bSm96"}]},["5jWuu","6PCZc"], "6PCZc", "parcelRequire3d38")

//# sourceMappingURL=forgotPass.7b1ac3fe.js.map
