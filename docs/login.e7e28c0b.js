...
})({"fiGXx":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "b427db87e7e28c0b";
"use strict";
...
loginForm.addEventListener("submit", async (event)=>{
    ...
    try {
        const { data, error } = await (0, _supabaseClient.supabase).auth.signInWithPassword({
            email,
            password,
            options: {
                captchaToken
...
},{"./supabaseClient":"bSm96"}]},["fiGXx","cReTB"], "cReTB", "parcelRequire3d38")

//# sourceMappingURL=login.e7e28c0b.js.map
