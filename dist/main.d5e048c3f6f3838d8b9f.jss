...
/* harmony import */ var _supabaseClient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
...
document.getElementById("discordSignUpBtn").addEventListener("click", function () {
  ...
  _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.signInWithOAuth({
    provider: 'discord',
    options: {
...
_supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.getSession().then(function (_ref) {
...
var signUpNewUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var form, emailInput, passwordInput, errorMessage, togglePassword, showError, clearError, resetCaptcha;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          form = document.getElementById('signUpFormDetails');
          emailInput = document.getElementById('signUpEmail');
          passwordInput = document.getElementById('signUpPassword');
          errorMessage = document.getElementById('confirmationMessage');
          togglePassword = document.getElementById('togglePassword'); // Show error message and shake effect
          ...
          form.addEventListener('submit', /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
              var email, password, captchaToken, validateEmail, _yield$supabase$auth$, data, error, user;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    captchaToken = hcaptcha.getResponse(); // Get the hCaptcha token
                  ...
                  case 18:
                    _context.prev = 18;
                    _context.next = 21;
                    return _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.signUp({
                      email: email,
                      password: password,
                      options: {
                        captchaToken: captchaToken // Send hCaptcha token
                      }
                    });
                  case 21:
...
var proceedSignOutBtn = document.getElementById('proceedSignOut');
var cancelSignOutBtn = document.getElementById('cancelSignOut');
...
proceedSignOutBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.prev = 0;
        _context.next = 3;
        return _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.signOut();
      case 3:
        _yield$supabase$auth$ = _context.sent;
        error = _yield$supabase$auth$.error;
        if (error) {
      ...
      case 9:
        ...
        console.error('Unexpected error during sign out:', _context.t0);
      case 12:
      case "end":
        return _context.stop();
    }
...
// DOM elements
var forgotPassForm = document.getElementById('forgotPassFormDetails');
var forgotPassEmailInput = document.getElementById('forgotPassEmail');
var forgotPassMessage = document.getElementById('forgotPassErrorMessage');
...
var showForgotPassError = function showForgotPassError(message) {
...
// Clear error message when valid input is entered
var clearForgotPassError = function clearForgotPassError() {
  forgotPassMessage.style.display = 'none';
  forgotPassMessage.classList.remove('shake');
};
...
var checkEmailExists = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(email) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.from('auth.users') // Querying the internal auth.users table
  ...
  return function checkEmailExists(_x) {
    return _ref.apply(this, arguments);
  };
}();

// Handle Forgot Password form submission
forgotPassForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var email, captchaToken, emailExists, _yield$supabase$auth$, error;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          event.preventDefault();
          email = forgotPassEmailInput.value.trim();
          captchaToken = hcaptcha.getResponse(); // Get the hCaptcha token
        ...
        case 18:
          _context2.next = 20;
          return _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.resetPasswordForEmail(email, {
...
var resetPassForm = document.getElementById('resetPassFormDetails');
var newPassInput = document.getElementById('newPassword');
var confirmPassInput = document.getElementById('confirmPassword');
var resetPassMessage = document.getElementById('resetPassErrorMessage');
var confirmationPopup = document.getElementById('confirmationPopup');
var togglePassword = document.getElementById('togglePassword');
var okBtn = document.getElementById('okBtn');

// Show error message with shake effect
var showResetPassError = function showResetPassError(message) {
...
var clearResetPassError = function clearResetPassError() {
  resetPassMessage.style.display = 'none';
  resetPassMessage.classList.remove('shake');
};
...
togglePassword.addEventListener('click', function () {
  var passwordFieldType = newPassInput.getAttribute('type');
  if (passwordFieldType === 'password') {
...
resetPassForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var newPass, confirmPass, _yield$supabase$auth$, error;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          event.preventDefault();
          newPass = newPassInput.value.trim();
          confirmPass = confirmPassInput.value.trim();
        ...
        case 10:
          _context.prev = 10;
          _context.next = 13;
          return _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.updateUser({
            password: newPass
          });
        case 13:
          _yield$supabase$auth$ = _context.sent;
...
var resendButton = document.getElementById('resendVerificationEmail');
var resendMessage = document.getElementById('resendMessage');
resendButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var email, _yield$supabase$auth$, error;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        resendMessage.textContent = ''; // Clear previous message
        email = localStorage.getItem('pendingVerificationEmail'); // Retrieve the email used for signup
        _context.prev = 2;
        _context.next = 5;
        return _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.api.resetPasswordForEmail(email);
      case 5:
        _yield$supabase$auth$ = _context.sent;
        error = _yield$supabase$auth$.error;
        // Use Supabase's API to resend email
...
console.log(_supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N);
var emailInput = document.getElementById('logInEmail');
var passwordInput = document.getElementById('logInPassword');
var errorMessage = document.getElementById('loginMessage');
var loginForm = document.getElementById('logInFormDetails');
var togglePassword = document.getElementById('togglePassword');
...
loginForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var email, password, validateEmail, captchaToken, _yield$supabase$auth$, data, error, user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          event.preventDefault();
          email = emailInput.value.trim();
          password = passwordInput.value.trim(); // Clear previous error messages
          clearLoginError();
        ...
        case 15:
          _context.prev = 15;
          _context.next = 18;
          return _supabaseClient__WEBPACK_IMPORTED_MODULE_0__/* .supabase */ .N.auth.signInWithPassword({
            email: email,
            password: password,
            options: {
              captchaToken: captchaToken // Send hCaptcha token
...
class RealtimeClient {
    ...
    connect() {
        ...
        __webpack_require__.e(/* import() */ 591).then(__webpack_require__.t.bind(__webpack_require__, 591, 23)).then(({ default: WS }) => {
...
const version_version = '2.7.0';
//# sourceMappingURL=version.js.map
;// ./node_modules/@supabase/storage-js/dist/module/lib/constants.js

const constants_DEFAULT_HEADERS = { 'X-Client-Info': `storage-js/${version_version}` };
//# sourceMappingURL=constants.js.map
...
const lib_version_version = '2.45.4';
//# sourceMappingURL=version.js.map
...
const lib_constants_DEFAULT_HEADERS = { 'X-Client-Info': `supabase-js-${JS_ENV}/${lib_version_version}` };
...
const module_lib_version_version = '2.65.0';
//# sourceMappingURL=version.js.map
...
const AUDIENCE = '';
const module_lib_constants_DEFAULT_HEADERS = { 'X-Client-Info': `gotrue-js/${module_lib_version_version}` };
...
var supabaseUrl = "https://xgosvhfnlusxpcgxnltv.supabase.co";
var supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inhnb3N2aGZubHVzeHBjZ3hubHR2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjU3NDcyNjgsImV4cCI6MjA0MTMyMzI2OH0.wQ7fpjb0SZIpNvCycsjXbOtKOTDvzr_p5o5kfZD_Jyk";
...
/******/ 			return "" + chunkId + "." + "d0121236c04da5f252f9" + ".jss";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "ch-test3:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkch_test3"] = self["webpackChunkch_test3"] || [];
...
/* harmony import */ var _auth_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(970);
/* harmony import */ var _authForgotPass_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(752);
/* harmony import */ var _authDash_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(682);
/* harmony import */ var _authResetPass_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(526);
/* harmony import */ var _authVerify_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(471);
/* harmony import */ var _authlog_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(262);
/* harmony import */ var _supabaseClient_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(106);
// src/js/index.js
