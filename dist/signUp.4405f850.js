...
})({"8PTUW":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "0f1b75b74405f850";
"use strict";
...
},{}],"9FX02":[function(require,module,exports) {
...
document.getElementById("discordSignUpBtn").addEventListener("click", function() {
    ...
    (0, _supabaseClient.supabase).auth.signInWithOAuth({
        provider: "discord",
        options: {
...
(0, _supabaseClient.supabase).auth.getSession().then(({ data: { session }, error })=>{
...
},{"./supabaseClient":"bSm96"}]},["8PTUW","9FX02"], "9FX02", "parcelRequire3d38")

//# sourceMappingURL=signUp.4405f850.js.map
