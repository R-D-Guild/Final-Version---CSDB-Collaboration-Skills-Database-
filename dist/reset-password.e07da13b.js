...
})({"grseN":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "435bbd69e07da13b";
"use strict";
...
},{}],"4DbOY":[function(require,module,exports) {
...
resetPassForm.addEventListener("submit", async (event)=>{
    ...
    try {
        ...
        const { error } = await (0, _supabaseClient.supabase).auth.updateUser({
            password: newPass
        });
        if (error) {
...
},{"./supabaseClient":"bSm96"}]},["grseN","4DbOY"], "4DbOY", "parcelRequire3d38")

//# sourceMappingURL=reset-password.e07da13b.js.map
